...
const CommentItem = memo(
  ...
  (prev, next) =>
    ...
    prev.rootParentId === next.rootParentId &&
    prev.movieSlug === next.movieSlug &&
    prev.movieName === next.movieName &&
    prev.currentPath.length === next.currentPath.length &&
    prev.currentPath.every((id, i) => id === next.currentPath[i]),
);
