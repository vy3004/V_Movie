  ...
  return (
    ...
    >
      ...
      {!hideIcon && isMicEnabled && (
        <div className="absolute -top-1 -left-1 w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-emerald-500 border-2 border-[#0a0a0c] flex items-center justify-center shadow-[0_0_10px_rgba(16,185,129,0.6)] z-20 transition-all duration-300 animate-in zoom-in">
